...
namespace llvm {
        ...
        class LegacyStringObfuscationPass: public llvm::ModulePass {
                public:
                static char ID; // pass identification
                bool is_flag = true;
                LegacyStringObfuscationPass() : ModulePass(ID) {}
                LegacyStringObfuscationPass(bool flag) : ModulePass(ID)
                {
                    is_flag = flag;
                }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                ...
                                Value *GEP = builder.CreateGEP(gvar->getValueType(), gvar,
                                                               ArrayRef<Value *>(indexList, 2), "arrayIdx");
                                Type *ElemTy = gvar->getValueType()->getArrayElementType();
                                LoadInst *loadElement = builder.CreateLoad(ElemTy, GEP, false);
...
static RegisterPass<LegacyStringObfuscationPass> X("GVDiv", "Global variable (i.e., const char*) diversification pass", false, true);
